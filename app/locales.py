...
PROXY_MESSAGES: dict[str, str] = {
    "en": (
        ...
        "Send your proxy in any of these formats:\n\n"
        "• <code>https://t.me/socks?server=host&port=1080&user=usr&pass=pwd</code>\n"
        ...
        "<code>https://t.me/socks?server=103.1.2.3&port=1080</code>"
    ),
    "bn": (
...
FRESH_SESSION_MESSAGES = {
    "en": {
        ...
        "auto_detect_btn": "🔍 Auto-detect 2FA from files",
        "auto_detect_found": "🔍 Auto-detect: found {detected} 2FA password(s) in your files.\n\nAccounts without a detected password will use the manually entered one (or proceed without 2FA).",
        "auto_detect_none": "⚠️ No 2FA passwords found in your files.\n\nPlease send your 2FA password manually now, or tap Skip:",
    ...
    "bn": {
        ...
        "auto_detect_btn": "🔍 ফাইল থেকে 2FA অটো-শনাক্ত করুন",
        "auto_detect_found": "🔍 অটো-শনাক্ত: আপনার ফাইলে {detected}টি 2FA পাসওয়ার্ড পাওয়া গেছে।\n\nযে অ্যাকাউন্টের পাসওয়ার্ড পাওয়া যায়নি সেগুলো ম্যানুয়াল পাসওয়ার্ড ব্যবহার করবে (বা 2FA ছাড়াই চলবে)।",
        "auto_detect_none": "⚠️ আপনার ফাইলে কোনো 2FA পাসওয়ার্ড পাওয়া যায়নি।\n\nএখন ম্যানুয়ালি আপনার 2FA পাসওয়ার্ড পাঠান, অথবা এড়িয়ে যান:",
    ...
    "hi": {
        ...
        "auto_detect_btn": "🔍 फ़ाइलों से 2FA ऑटो-डिटेक्ट करें",
        "auto_detect_found": "🔍 ऑटो-डिटेक्ट: आपकी फ़ाइलों में {detected} 2FA पासवर्ड मिले।\n\nजिन खातों का पासवर्ड नहीं मिला, वे मैन्युअल पासवर्ड का उपयोग करेंगे (या 2FA के बिना चलेंगे)।",
        "auto_detect_none": "⚠️ आपकी फ़ाइलों में कोई 2FA पासवर्ड नहीं मिला।\n\nकृपया अभी अपना 2FA पासवर्ड भेजें या छोड़ें:",
    ...
    "ur": {
        ...
        "auto_detect_btn": "🔍 فائلوں سے 2FA خودکار شناخت",
        "auto_detect_found": "🔍 خودکار شناخت: آپ کی فائلوں میں {detected} 2FA پاسورڈز ملے۔\n\nجن اکاؤنٹس کا پاسورڈ نہیں ملا وہ دستی پاسورڈ استعمال کریں گے (یا 2FA کے بغیر چلیں گے)۔",
        "auto_detect_none": "⚠️ آپ کی فائلوں میں کوئی 2FA پاسورڈ نہیں ملا۔\n\nبراہ کرم ابھی اپنا 2FA پاسورڈ بھیجیں یا چھوڑ دیں:",
    ...
    "ar": {
        ...
        "auto_detect_btn": "🔍 اكتشاف 2FA تلقائيًا من الملفات",
        "auto_detect_found": "🔍 الكشف التلقائي: تم العثور على {detected} كلمة مرور 2FA في ملفاتك.\n\nالحسابات التي لم يُعثر لها على كلمة مرور ستستخدم كلمة المرور اليدوية (أو تمضي بدون 2FA).",
        "auto_detect_none": "⚠️ لم يتم العثور على كلمات مرور 2FA في ملفاتك.\n\nأرسل كلمة مرور 2FA يدويًا الآن، أو انقر تخطَّ:",
    ...
    "zh": {
        ...
        "skip_2fa": "⏭ 跳过 (无 2FA)",
        "auto_detect_btn": "🔍 从文件中自动检测 2FA",
        "auto_detect_found": "🔍 自动检测：在您的文件中找到 {detected} 个 2FA 密码。\n\n未检测到密码的账户将使用手动输入的密码（若提供）或继续无 2FA。",
        "auto_detect_none": "⚠️ 未在您的文件中找到 2FA 密码。\n\n请立即手动发送 2FA 密码，或点击跳过：",
...
TWO_FACTOR_MODE_PROMPT = {
    "en": (
        "🔐 <b>2FA Operation Mode</b>\n\n"
        "📦 Found <b>{count}</b> session(s)\n\n"
        "Please select how you want to apply 2FA passwords:"
    ),
    "bn": (
        "🔐 <b>২FA মোড নির্বাচন</b>\n\n"
        "📦 <b>{count}</b>টি সেশন পাওয়া গেছে\n\n"
        "পাসওয়ার্ড প্রয়োগের মাধ্যম নির্বাচন করুন:"
    ),
    "hi": (
        "🔐 <b>2FA मोड चयन</b>\n\n"
        "📦 <b>{count}</b> सेशन मिले\n\n"
        "कृपया चुनें कि आप 2FA पासवर्ड कैसे लागू करना चाहते हैं:"
    ),
    "ur": (
        "🔐 <b>2FA موڈ کا انتخاب</b>\n\n"
        "📦 <b>{count}</b> سیشنز ملے\n\n"
        "براہ کرم منتخب کریں کہ آپ 2FA پاسورڈ کیسے لاگو کرنا چاہتے ہیں:"
    ),
    "ar": (
        "🔐 <b>وضع نمط 2FA</b>\n\n"
        "📦 تم العثور على <b>{count}</b> جلسة\n\n"
        "يرجى تحديد كيفية تطبيق كلمة مرور 2FA:"
    ),
    "zh": (
        "🔐 <b>2FA 操作模式</b>\n\n"
        "📦 找到 <b>{count}</b> 个会话\n\n"
...
TWO_FACTOR_MODE_LABELS = {
    "en": {
        "auto": "Automatic (1 Password for ALL accounts)",
        "manual": "Manual (Enter per-session individual password)",
    },
    "bn": {
        "auto": "স্বয়ংক্রিয় (সব অ্যাকাউন্টের জন্য ১টি পাসওয়ার্ড)",
        "manual": "ম্যানুয়াল (প্রতি সেশনের জন্য আলাদা পাসওয়ার্ড)",
    },
    "hi": {
        "auto": "स्वचालित (सभी खातों के लिए 1 पासवर्ड)",
        "manual": "मैन्युअल (प्रत्येक खाते का अलग पासवर्ड)",
    },
    "ur": {
        "auto": "خودکار (تمام اکاؤنٹس کے لیے 1 پاسورڈ)",
        "manual": "دستی (ہر اکاؤنٹ کے لیے الگ پاسورڈ)",
    },
    "ar": {
        "auto": "تلقائي (كلمة مرور واحدة لجميع الحسابات)",
        "manual": "يدوي (كلمة مرور منفصلة لكل حساب)",
    },
    "zh": {
        "auto": "自动（所有账户统一密码）",
        "manual": "手动（逐个输入单独密码）",
...
TWO_FACTOR_BATCH_OLD_PROMPT = {
    "en": (
        "⚡ <b>Batch 2FA Change (Automatic Mode)</b>\n\n"
        "📦 Total: <b>{count}</b> accounts\n\n"
        "🔑 Enter the <b>current (old) 2FA password</b> to apply to ALL accounts:"
    ),
    "bn": (
        "⚡ <b>ব্যাচ ২FA পরিবর্তন (স্বয়ংক্রিয় মোড)</b>\n\n"
        "📦 মোট: <b>{count}</b>টি অ্যাকাউন্ট\n\n"
        "🔑 সব অ্যাকাউন্টে প্রয়োগ করতে <b>বর্তমান (পুরানো) ২FA পাসওয়ার্ড</b> লিখুন:"
    ),
    "hi": (
        "⚡ <b>बैच 2FA बदलाव (स्वचालित मोड)</b>\n\n"
        "📦 कुल: <b>{count}</b> खाते\n\n"
        "🔑 सभी खातों पर लागू करने के लिए <b>वर्तमान (पुराना) 2FA पासवर्ड</b> दर्ज करें:"
    ),
    "ur": (
        "⚡ <b>بیچ 2FA تبدیلی (خودکار موڈ)</b>\n\n"
        "📦 کل: <b>{count}</b> اکاؤنٹس\n\n"
        "🔑 تمام اکاؤنٹس پر لاگو کرنے کے لیے <b>موجودہ (پرانا) 2FA پاسورڈ</b> درج کریں:"
    ),
    "ar": (
        "⚡ <b>تغيير 2FA دفعة واحدة (الوضع التلقائي)</b>\n\n"
        "📦 الإجمالي: <b>{count}</b> حساب\n\n"
        "🔑 أدخل <b>كلمة مرور 2FA الحالية (القديمة)</b> لتطبيقها على جميع الحسابات:"
    ),
    "zh": (
        "⚡ <b>批量修改 2FA (自动模式)</b>\n\n"
        "📦 总计: <b>{count}</b> 个账户\n\n"
        "🔑 请输入要应用于所有账户的<b>当前（旧）2FA 密码</b>："
    ),
}

TWO_FACTOR_BATCH_NEW_PROMPT = {
    "en": (
        "🔑 Enter the <b>NEW 2FA password</b> to apply to ALL <b>{count}</b> accounts:"
    ),
    "bn": (
        "🔑 সব <b>{count}</b>টি অ্যাকাউন্টে প্রয়োগ করতে <b>নতুন ২FA পাসওয়ার্ড</b> লিখুন:"
    ),
    "hi": (
        "🔑 सभी <b>{count}</b> खातों पर लागू करने के लिए <b>नया 2FA पासवर्ड</b> दर्ज करें:"
    ),
    "ur": (
        "🔑 تمام <b>{count}</b> اکاؤنٹس پر لاگو کرنے کے لیے <b>نیا 2FA پاسورڈ</b> درج کریں:"
    ),
    "ar": (
        "🔑 أدخل <b>كلمة مرور 2FA الجديدة</b> لتطبيقها على جميع <b>{count}</b> حساب:"
    ),
    "zh": (
        "🔑 请输入要应用于所有 <b>{count}</b> 个账户的<b>新 2FA 密码</b>："
    ),
}

TWO_FACTOR_BATCH_DISABLE_PROMPT = {
    "en": (
        "⚡ <b>Batch 2FA Disable (Automatic Mode)</b>\n\n"
        "📦 Total: <b>{count}</b> accounts\n\n"
        "🔑 Enter current 2FA password to <b>DISABLE 2FA</b> on ALL accounts:"
    ),
    "bn": (
        "⚡ <b>ব্যাচ ২FA নিষ্ক্রিয় (স্বয়ংক্রিয় মোড)</b>\n\n"
        "📦 মোট: <b>{count}</b>টি অ্যাকাউন্ট\n\n"
        "🔑 সব অ্যাকাউন্টের ২FA <b>বন্ধ করতে</b> বর্তমান ২FA পাসওয়ার্ড লিখুন:"
    ),
    "hi": (
        "⚡ <b>बैच 2FA बंद (स्वचालित मोड)</b>\n\n"
        "📦 कुल: <b>{count}</b> खाते\n\n"
        "🔑 सभी खातों का 2FA <b>बंद करने</b> के लिए वर्तमान 2FA पासवर्ड दर्ज करें:"
    ),
    "ur": (
        "⚡ <b>بیچ 2FA غیر فعال (خودکار موڈ)</b>\n\n"
        "📦 کل: <b>{count}</b> اکاؤنٹس\n\n"
        "🔑 تمام اکاؤنٹس پر 2FA <b>غیر فعال کرنے</b> کے لیے موجودہ 2FA پاسورڈ درج کریں:"
    ),
    "ar": (
        "⚡ <b>تعطيل 2FA دفعة واحدة (الوضع التلقائي)</b>\n\n"
        "📦 الإجمالي: <b>{count}</b> حساب\n\n"
        "🔑 أدخل كلمة مرور 2FA الحالية لـ <b>تعطيل 2FA</b> في جميع الحسابات:"
    ),
    "zh": (
        "⚡ <b>批量禁用 2FA (自动模式)</b>\n\n"
        "📦 总计: <b>{count}</b> 个账户\n\n"
        "🔑 请输入当前 2FA 密码以在所有账户上<b>禁用 2FA</b>："
    ),
}
...
READ_OTP_MESSAGES = {
    ...
    "hi": {
        ...
        "error_inconclusive": (
            "⚠️ <b>OTP नहीं पढ़ सके।</b>\n\n📁 सेशन: <code>{session_id}</code>कनेक्शन त्रुटि हुई।"
        ),
        "no_api_credentials": (
            "⚠️ <b>OTP नहीं पढ़ सके।</b>\n\n📁 सेशन:"
            " <code>{session_id}</code>\n"
...
PAYMENT_NOT_DETECTED_MESSAGES = {
    ...
    "zh": ("⏳ 尚未检测到付款。请再次核对金额和钱包地址，稍后再按一次按钮。"),
}
...
PAYMENT_METHOD_UNAVAILABLE_MESSAGES = {
    ...
    "bn": ("❌ এই পেমেন্ট পদ্ধতিটি বর্তমানে অনুপলব্ধ। অনুগ্রহ করে অন্য একটি বেছে নিন।"),
    "hi": ("❌ यह भुगतान विधि अभी उपलब्ध नहीं है। कृपया कोई दूसरी विधि चुनें।"),
    "ur": (
        "❌ ادائیگی کا یہ طریقہ فی الحال دستیاب نہیں ہے۔ براہ کرم کوئی اور طریقہ منتخب کریں۔"
    ),
    "ar": ("❌ هذه طريقة الدفع غير متاحة حالياً. يرجى اختيار طريقة أخرى."),
    "zh": ("❌ 该支付方式当前不可用。请选择其他方式。"),
}

LOGIN_EMAIL_PROMPTS = {
    "en": (
        "📧 <b>Change Login Email</b>\n\n"
        "This tool changes the login email of your Telegram accounts to a fresh "
        "temporary address (Mail.tm) — no email service required.\n\n"
        "<i>⚠️ Only accounts that already have a login email set will be changed.</i>\n\n"
        "🛠 Each account:\n"
        "• Creates a disposable email + receives the OTP (up to 25 sec)\n"
        "• Verifies the new email with Telegram\n\n"
        "📤 Please upload your account archive (<code>.zip</code>) or a "
        "<code>.session</code> file."
    ),
    "bn": (
        "📧 <b>লগইন ইমেল পরিবর্তন</b>\n\n"
        "এই টুল আপনার টেলিগ্রাম অ্যাকাউন্টের লগইন ইমেল একটি নতুন অস্থায়ী ঠিকানায় "
        "(Mail.tm) পরিবর্তন করে — কোনো ইমেল সার্ভিসের প্রয়োজন নেই।\n\n"
        "<i>⚠️ শুধুমাত্র যে অ্যাকাউন্টগুলিতে আগে থেকে লগইন ইমেল সেট আছে সেগুলিই পরিবর্তন হবে।</i>\n\n"
        "🛠 প্রতিটি অ্যাকাউন্ট:\n"
        "• একটি ডিসপোজেবল ইমেল তৈরি করে এবং OTP গ্রহণ করে (২৫ সেকেন্ড পর্যন্ত)\n"
        "• টেলিগ্রাম দিয়ে নতুন ইমেল যাচাই করে\n\n"
        "📤 অনুগ্রহ করে আপনার অ্যাকাউন্ট আর্কাইভ (<code>.zip</code>) বা একটি "
        "<code>.session</code> ফাইল আপলোড করুন।"
    ),
    "hi": (
        "📧 <b>लॉगिन ईमेल बदलें</b>\n\n"
        "यह टूल आपके टेलीग्राम खातों का लॉगिन ईमेल एक नए अस्थायी पते "
        "(Mail.tm) में बदलता है — किसी ईमेल सेवा की आवश्यकता नहीं।\n\n"
        "<i>⚠️ केवल वे खाते बदले जाएंगे जिनमें पहले से लॉगिन ईमेल सेट है।</i>\n\n"
        "🛠 प्रत्येक खाता:\n"
        "• एक डिस्पोज़ेबल ईमेल बनाता है और OTP प्राप्त करता है (25 सेकंड तक)\n"
        "• टेलीग्राम से नए ईमेल की पुष्टि करता है\n\n"
        "📤 कृपया अपना खाता संग्रह (<code>.zip</code>) या एक <code>.session</code> फ़ाइल अपलोड करें।"
    ),
    "ur": (
        "📧 <b>لاگ ان ای میل تبدیل کریں</b>\n\n"
        "یہ ٹول آپ کے ٹیلیگرام اکاؤنٹس کا لاگ ان ای میل ایک نئے عارضی پتے "
        "(Mail.tm) میں تبدیل کرتا ہے — کسی ای میل سروس کی ضرورت نہیں۔\n\n"
        "<i>⚠️ صرف وہ اکاؤنٹس تبدیل ہوں گے جن پر پہلے سے لاگ ان ای میل سیٹ ہے۔</i>\n\n"
        "🛠 ہر اکاؤنٹ:\n"
        "• ایک ڈسپوزایبل ای میل بناتا ہے اور OTP حاصل کرتا ہے (25 سیکنڈ تک)\n"
        "• ٹیلیگرام سے نئے ای میل کی تصدیق کرتا ہے\n\n"
        "📤 براہ کرم اپنا اکاؤنٹ آرکائیو (<code>.zip</code>) یا ایک <code>.session</code> فائل اپ لوڈ کریں۔"
    ),
    "ar": (
        "📧 <b>تغيير بريد التسجيل</b>\n\n"
        "تغيّر هذه الأداة بريد التسجيل لحساباتك إلى عنوان مؤقت جديد (Mail.tm) "
        "— دون الحاجة لأي خدمة بريد.\n\n"
        "<i>⚠️ الحسابات التي تم ضبط بريد تسجيل عليها مسبقًا فقط هي التي ستتغيّر.</i>\n\n"
        "🛠 لكل حساب:\n"
        "• إنشاء بريد مؤقت واستلام رمز OTP (حتى 25 ثانية)\n"
        "• التحقق من البريد الجديد عبر تيليجرام\n\n"
        "📤 يرجى رفع ملف الأرشيف (<code>.zip</code>) أو ملف <code>.session</code>."
    ),
    "zh": (
        "📧 <b>修改登录邮箱</b>\n\n"
        "此工具会将您 Telegram 账号的登录邮箱更换为新的临时邮箱地址 (Mail.tm) — "
        "无需任何邮箱服务。\n\n"
        "<i>⚠️ 只有曾经设置过登录邮箱的账号才会被修改。</i>\n\n"
        "🛠 每个账号：\n"
        "• 创建一次性邮箱并接收验证码（最长 25 秒）\n"
        "• 通过 Telegram 验证新邮箱\n\n"
        "📤 请上传您的账号压缩包 (<code>.zip</code>) 或 <code>.session</code> 文件。"
    ),
}

LOGIN_EMAIL_MESSAGES = {
    "en": {
        "title": "📧 <b>Change Login Email Results</b>",
        "processing": "🔄 <b>Changing Login Emails...</b>",
        "cancelled": "❌ <b>Operation Cancelled</b>",
    },
    "bn": {
        "title": "📧 <b>লগইন ইমেল পরিবর্তনের ফলাফল</b>",
        "processing": "🔄 <b>লগইন ইমেল পরিবর্তন হচ্ছে...</b>",
        "cancelled": "❌ <b>অপারেশন বাতিল করা হয়েছে</b>",
    },
    "hi": {
        "title": "📧 <b>लॉगिन ईमेल परिवर्तन परिणाम</b>",
        "processing": "🔄 <b>लॉगिन ईमेल बदले जा रहे हैं...</b>",
        "cancelled": "❌ <b>ऑपरेशन रद्द किया गया</b>",
    },
    "ur": {
        "title": "📧 <b>لاگ ان ای میل تبدیلی کے نتائج</b>",
        "processing": "🔄 <b>لاگ ان ای میلز تبدیل ہو رہی ہیں...</b>",
        "cancelled": "❌ <b>آپریشن منسوخ کر دیا گیا</b>",
    },
    "ar": {
        "title": "📧 <b>نتائج تغيير بريد التسجيل</b>",
        "processing": "🔄 <b>جاري تغيير بريد التسجيل...</b>",
        "cancelled": "❌ <b>تم إلغاء العملية</b>",
    },
    "zh": {
        "title": "📧 <b>修改登录邮箱结果</b>",
        "processing": "🔄 <b>正在修改登录邮箱...</b>",
        "cancelled": "❌ <b>已取消操作</b>",
    },
}
